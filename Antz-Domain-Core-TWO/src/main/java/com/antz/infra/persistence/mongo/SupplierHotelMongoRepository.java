 ...
 **/
public interface SupplierHotelMongoRepository extends MongoRepository<SupplierHotel, String> {

    Optional<SupplierHotel> findBySupplierHotelId(SupplierHotelId supplierHotelId);
}
